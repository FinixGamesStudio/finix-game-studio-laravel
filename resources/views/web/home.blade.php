        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p>We are a team of talented game developers dedicated to creating engaging and entertaining experiences for everyone! 🎮 Our passion for game design drives us to craft unique gameplay mechanics, captivating visuals, and unforgettable moments.</p>
                    <p>Explore our diverse range of games, including classic card games like Blackjack and Spades, as well as educational adventures for kids such as Learn Farm Animals. Whether you're navigating the challenges of Snake or breaking through walls in Wall Breaker, there's something for everyone. Dive into rhythmic fun with Tabla or sharpen your mind with Fill the Line – our games are designed to entertain and inspire!</p>
                    <p>Join us on this exciting gaming journey and discover the thrill of creativity and fun with Finix Games Studio!</p>
                </div>
            </div>
        </div>
